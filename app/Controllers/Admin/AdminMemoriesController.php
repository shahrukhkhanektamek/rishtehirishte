...
class AdminMemoriesController extends BaseController
{
     protected $arr_values = array(
        ...
        'table_name'=>'memories',
        'page_title'=>'Memories',
        "folder_name"=>'backend/admin/memories',
        "upload_path"=>'upload/memories/',
        "page_name"=>'memories-single.php',
       );
    ...
    public function update()
    {
        ...
        if($entryStatus)
        {
           ...
           $image = $ImageModel->upload_image('image', $this->request,[],$this->arr_values['upload_path']);
           if(!empty($image)) $update_data['image'] = $image;

           $video = $ImageModel->upload_image('video', $this->request,[],$this->arr_values['upload_path']);
           if(!empty($video)) $update_data['video'] = $video;
