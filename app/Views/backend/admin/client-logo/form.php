                        ...
                        <div class="live-preview">
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <input type="text" class="form-control" name="name" placeholder="" required value="<?=@$row->name?>">
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="alt" placeholder="" required value="<?=@$row->alt?>">
                                </div>
