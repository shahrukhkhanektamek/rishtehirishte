            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-header p-0">
                        <div class="db-pro-stat" style="padding: 10px 15px 0px 15px;">
                            <div class="row">
                                <div class="col-6">
                                    <button class="btn btn-secondary w-100 select-type active" data-type="1">Receive Interest</button>
                                </div>
                                <div class="col-6">
                                    <button class="btn btn-secondary w-100 select-type" data-type="2">Sent Interest</button>
                                </div>
                                <ul class="d-flex justify-content-start mt-1 mb-0">
                                    <li class="m-1 mb-0 mt-0"><button class="btn btn-secondary select-status active" data-status="">All Interest</button></li>
                                    <li class="m-1 mb-0 mt-0"><button class="btn btn-secondary select-status" data-status="accept">Accept Interest</button></li>
                                    <li class="m-1 mb-0 mt-0"><button class="btn btn-secondary select-status" data-status="pending">Pending Interest</button></li>
                                    <li class="m-1 mb-0 mt-0"><button class="btn btn-secondary select-status" data-status="decline">Decline Interest</button></li>
                                </ul>                                    
                            </div>
                        </div>
...
<script>
   var data = '';
   var main_url = "<?=$data['route']?>/load_inbox_data";
   let type = 1;
    var status = '';
