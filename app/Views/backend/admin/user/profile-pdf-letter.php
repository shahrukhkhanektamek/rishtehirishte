...
<div id="header">
    <img src="<?= base_url('images/letterhead.jpg') ?>" style="width:100%; height:100%; object-fit: contain;">
</div>

<div id="footer">
    <img src="<?= base_url('images/letterhead.jpg') ?>" style="width:100%; height:60px; object-fit: contain;">
    <div>Powered by Unique Solution</div>
</div>
                            ...
                            <tr>
                                ...
                                <td width="100%" style="padding-left:6px;">
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                        ...
                                        <!-- Family Detail -->
                                        <tr>
                                            <td style="font-size:20px;font-weight:700;color:#C9302C;padding-bottom:10px;text-align: center;text-align: center;">
                                                <span style="    background: #0a5fa4;color: white;padding: 5px 35px;display: block;width: fit-content;margin: 0 auto;margin-top: 10px;border-radius: 30px;">Family</span>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td
                                                style="font-size:20px;font-weight:700;color:#C9302C;padding-bottom:10px;text-align: center;">
                                                <span>Basic Details</span></td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            <td
                                                style="font-size:18px;font-weight:700;color:#C9302C;padding-bottom:8px;text-align: center;">
                                                <span>Religious Background</span></td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:13px;color:#333333;">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                        ...
                                        <tr>
                                            <td
                                                style="font-size:18px;font-weight:700;color:#C9302C;padding-bottom:8px;text-align: center;">
                                                <span>Location, Education &amp; Career</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="font-size:13px;color:#333333;">
