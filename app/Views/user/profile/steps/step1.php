        ...
        <form method="post" action="<?=base_url('user/profile/step1')?>" id="step1FormData" class="row form_data" novalidate>
            ...
            <div class="col-md-6 col-12">
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="mobile" name="phone" placeholder="" value="<?=@$row->phone?>">
                </div>
            </div>
            <div class="col-md-6 col-12">
                <div class="form-group">
            ...
            <div class="col-md-4 col-12">
                <div class="form-group">
                    ...
                    <input type="time" class="form-control" id="dobtime" name="time_of_birth" placeholder="" value="<?=@$row->time_of_birth?>">
                </div>
            </div>
            <div class="col-md-4 col-12">
                <div class="form-group">
            ...
            <div class="col-md-6 col-12">
                ...
                <select class="chosen-select" name="profilefor" >
