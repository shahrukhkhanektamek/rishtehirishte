                                ...
                                <div class="card-header">
                                    <div class="row mt-2">
                                        <div class="col-md-2">
                                         ...
                                         <div class="col-md-4">
                                            <select class="form-control" id="education-category">
...
<script>
   ...
   function get_url_data()
   {
       ...
       var category = $("#education-category").val();
       var limit = $("#limit").val();
       var filter_search_value = $(".search-input").val();
       data = `category=${category}&status=${status}&order_by=${order_by}&limit=${limit}&filter_search_value=${filter_search_value}`;
   }
    get_url_data();
   url = main_url+'?'+data;
   load_table();
   $(document).on("change", "#statuschange, .order_by, .limit, #education-category",(function(e) {
      get_url_data();
      url =main_url+"?"+data;
      load_table();
   }));
