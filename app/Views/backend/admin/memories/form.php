                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-6 hide">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <img class="upload-img-view img-thumbnail mt-2 mb-2 image" id="viewer" style="width:auto;height:120px;overflow:hidden;" src="<?=empty($row)?image_check('default.jpg'):base_url().$data['upload_path'].@$row->image?>" alt="banner image"/>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-12 mt-2">
                                        <!-- Video preview yahan dikhega -->
                                        <video id="videoPreview" src="<?=base_url().$data['upload_path'].@$row->video?>" width="400" controls style="display:<?=empty($row)?'none':'block'?>;"></video>
                                    </div>
                                </div>
                                <script>
                                    ...
                                    videoInput.addEventListener('change', function() {
                                        ...
                                        if (file) {
                                            ...
                                            videoPreview.style.display = 'block'; // video show karo
                                        } else {
                                            videoPreview.src = '';
