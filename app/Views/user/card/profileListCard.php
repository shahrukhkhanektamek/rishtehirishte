    ...
    <div class="db-int-pro-3">
        ...
        ?>
            <?php if($value->request_status=='pending'){ ?>
                <button type="button" class=" mb-1 cta-dark bg-info">Interest Sent</button>
            ...
            <?php }else{ ?>
                <?php if($value->request_status=='pending'){ ?>
                    <button type="button" class=" mb-1 cta-dark bg-info">Interest Recieve</button>
        ...
        ?>
        <button type="button" class=" cta-dark view-contact" style="background: deeppink;" data-id="<?=encript($value->id)?>">
