                            ...
                            <ul class="slider">
                                <li>
                                    <div class="db-new-pro">
                                        <img src="https://www.rishtehirishte.co.in/upload/20-06-2025-10-25-41-amass1.jpg" loading="lazy" alt="profile" class="profile img-fluid">
                                        <div>
                                            <h5 class="list-id-number">RHR-21434</h5>
                                            <span class="city">22</span><span class="age">	&#8226; Hindu</span>
                                        </div>
                                        <a href="user-profile-details.php" class="fclick">&nbsp;</a>
                                    </div>
                                </li>
                                <li>
                                    <div class="db-new-pro">
                                        <img src="https://www.rishtehirishte.co.in/upload/12-05-2025-11-31-27-am2.jpg" loading="lazy" alt="profile" class="profile img-fluid">
                                        <div>
                                            <h5 class="list-id-number">RHR-21434</h5>
                                            <span class="city">22</span><span class="age">	&#8226; Hindu</span>
                                        </div>
                                        <div class="pro-ave" title="User currently available"><span class="pro-ave-yes"></span></div>
                                        <a href="user-profile-details.php" class="fclick">&nbsp;</a>
                                    </div>
                                </li>
                                <li>
                                    <div class="db-new-pro">
                                        <img src="https://www.rishtehirishte.co.in/upload/28-05-2025-10-24-42-amas1.jpg" loading="lazy" alt="profile" class="profile img-fluid">
                                        <div>
                                            <h5 class="list-id-number">RHR-21434</h5>
                                            <span class="city">22</span><span class="age">	&#8226; Hindu</span>
                                        </div>
                                ...
                                <li>
                                    <div class="db-new-pro">
                                        <img src="https://www.rishtehirishte.co.in/upload/21-03-2025-10-30-19-amq1.jpg" loading="lazy" alt="profile" class="profile img-fluid">
                                        <div>
                                            <h5 class="list-id-number">RHR-21434</h5>
                                            <span class="city">22</span><span class="age">	&#8226; Hindu</span>
                                        </div>
                                ...
                                <li>
                                    <div class="db-new-pro">
                                        <img src="https://www.rishtehirishte.co.in/upload/03-06-2025-10-25-15-amarchit1.jpg" loading="lazy" alt="profile" class="profile img-fluid">
                                        <div>
                                            <h5 class="list-id-number">RHR-21434</h5>
                                            <span class="city">22</span><span class="age">	&#8226; Hindu</span>
                                        </div>
            ...
            <ul>
                <li>
                    <div class="db-int-pro-1"> 
                        <img class="img-fluid hide" src="https://ik.imagekit.io/9sqym9p8y/@inabilansari/profile-square.svg" loading="lazy" alt="image"> 
                        <span class="badge bg-primary user-pla-pat">Platinum user</span>
                    </div>
                    <div class="db-int-pro-2">
                        <h5 class="list-id-number">RHR-21434</h5> 
                        <ol class="poi">
                            <li>Age: <strong>18</strong></li>
                            <li>Height: <strong>5.4</strong></li>
                            <li>Religion: <strong>Hindu</strong></li>
                            <li>Caste: <strong>Chettiar</strong></li>
                            <li>Marital: <strong>Never Married</strong></li>
                            <li>Country: <strong>India</strong></li>
                        </ol>
                        <ol class="poi poi-date" style="opacity:0.6;">
                            <li>Education: &nbsp;|&nbsp; Occupation: &nbsp;|&nbsp; Income:</li>
                        </ol>
                        <a href="user-profile-details.php" class="cta-5" target="_blank">View full profile <i class="fas fa-arrow-right ms-2"></i></a>
                    </div>
