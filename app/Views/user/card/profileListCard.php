<?php foreach ($data_list as $key => $value) { ?>
 <li>
    ...
    <div class="db-int-pro-3">
        <button type="button" class="btn btn-success btn-sm mb-1 send-interest" data-id="<?=encript($value->id)?>">
        ...
        <button type="button" class="btn btn-outline-danger btn-sm view-contact" data-id="<?=encript($value->id)?>">
